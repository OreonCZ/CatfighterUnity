...
public class Items
{
    ...
    public static float GetItemVariable(ItemType itemType)
    {
        switch (itemType)
        {
            ...
            case ItemType.sword_2: return 1.5f;
            case ItemType.sword_3: return 2f;
            case ItemType.sword_4: return 2.5f;
            case ItemType.boots_1: return 10f;
            case ItemType.boots_2: return 20f;
            case ItemType.boots_3: return 30f;
            case ItemType.boots_4: return 40f;
            case ItemType.hp_1: return 10f;
            case ItemType.hp_2: return 12f;
            case ItemType.hp_3: return 15f;
            case ItemType.hp_4: return 20f;
            case ItemType.milk_1: return 1f;
            case ItemType.milk_2: return 1f;
            case ItemType.milk_3: return 1f;
            case ItemType.milk_4: return 1f;
            case ItemType.stamina_1: return 20f;
            case ItemType.stamina_2: return 40f;
            case ItemType.stamina_3: return 60f;
            case ItemType.stamina_4: return 80f;
